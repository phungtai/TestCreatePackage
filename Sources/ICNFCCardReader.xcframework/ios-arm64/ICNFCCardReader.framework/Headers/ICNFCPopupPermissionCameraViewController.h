...
@protocol ICPopupPermissionCameraDelegate <NSObject>
...
@interface ICNFCPopupPermissionCameraViewController : ICNFCBaseViewController

@property (nonatomic) id<ICPopupPermissionCameraDelegate> delegate;
